...
public static final String strURL="jdbc:mysql://127.0.0.1:3306/ontology_pizza?useUnicode=true&characterEncoding=utf8";
...
public static final String strDB="MYSQL";
    public static void main(String[] args) throws SQLException
    {
        ...
        {            
            ...
            Model defModel=maker.createModel("pizzaOntology");
            FileInputStream read=null;
            try
            {
                File file = new File("F:/xusoft/intelliJ IDEA/Ontology/src/main/java/pizzaModel/pizza.owl");
